...
@section('container')
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mb-1">
      <form action="/surat/skck" method="GET">
        {{-- @if (request('category')) 
  ...
  <a href="/surat/skck/create" class="btn btn-primary">Buat SKCK</a>
      ...
      <tbody>
          @foreach ($skck as $data)
              <tr>
                  ...
                  <td>
                    <a href="/surat/skck/{{ $data->id }}" class="badge bg-info" target="_blank"><i class="bi bi-printer"></i></a>
                    <a href="/surat/skck/{{ $data->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
                    <form action="/surat/skck/{{ $data->id }}" method="POST" class="d-inline">
                      @method('DELETE')
                      @csrf
