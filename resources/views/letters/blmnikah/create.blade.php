...
@section('container')
    ...
    <div class="col-lg-8 ms-4">
        <form action="/surat/blmnikah" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('kebangsaan') is-invalid @enderror" id="kebangsaan" name="kebangsaan" required value="{{ old('kebangsaan') }}">
              @error('kebangsaan')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
