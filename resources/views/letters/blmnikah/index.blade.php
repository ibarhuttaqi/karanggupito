...
@section('container')
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mb-1">
      <form action="/surat/blmnikah" method="GET">
        {{-- @if (request('category')) 
  ...
  <a href="/surat/blmnikah/create" class="btn btn-primary">Buat Surat Belum Nikah</a>
      ...
      <tbody>
          @foreach ($blmnikah as $data)
              <tr>
                  ...
                  <td>{{ $data['alamat'] }}</td>
                  <td>
                    <a href="/surat/blmnikah/{{ $data->id }}" class="badge bg-info" target="_blank"><i class="bi bi-printer"></i></a>
                    <a href="/surat/blmnikah/{{ $data->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
                    <form action="/surat/blmnikah/{{ $data->id }}" method="POST" class="d-inline">
                      @method('DELETE')
                      @csrf
