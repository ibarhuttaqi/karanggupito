...
@section('container')
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mb-1">
      <form action="/surat/bepergian" method="GET">
        {{-- @if (request('category')) 
  ...
  <a href="/surat/bepergian/create" class="btn btn-primary">Buat Surat Bepergian</a>
      ...
      <tbody>
          @foreach ($bepergian as $data)
              <tr>
                  ...
                  <td>
                    <a href="/surat/bepergian/{{ $data->id }}" class="badge bg-info" target="_blank"><i class="bi bi-printer"></i></a>
                    <a href="/surat/bepergian/{{ $data->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
                    <form action="/surat/bepergian/{{ $data->id }}" method="POST" class="d-inline">
                      @method('DELETE')
                      @csrf
