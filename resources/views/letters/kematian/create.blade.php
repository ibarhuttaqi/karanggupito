...
@section('container')
    ...
    <div class="col-lg-8 ms-4">
        <form action="/surat/kematian" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('hariMeninggal') is-invalid @enderror" id="hariMeninggal" name="hariMeninggal" required value="{{ old('hariMeninggal') }}">
                @error('hariMeninggal')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
              ...
              <div class="mb-3">
                ...
                <input type="date" class="form-control @error('tanggalMeninggal') is-invalid @enderror" id="tanggalMeninggal" name="tanggalMeninggal" required value="{{ old('tanggalMeninggal') }}">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('tempatMeninggal') is-invalid @enderror" id="tempatMeninggal" name="tempatMeninggal" required value="{{ old('tempatMeninggal') }}">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('sebabKematian') is-invalid @enderror" id="sebabKematian" name="sebabKematian" required value="{{ old('sebabKematian') }}">
                @error('sebabKematian')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
