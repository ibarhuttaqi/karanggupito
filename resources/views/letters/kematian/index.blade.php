...
@section('container')
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mb-1">
      <form action="/surat/kematian" method="GET">
        {{-- @if (request('category')) 
  ...
  <a href="/surat/kematian/create" class="btn btn-primary">Buat Surat Kematian</a>
    ...
    <table class="table table-responsive small col-sm-10 table-striped mt-2 ms-0">
      <thead>
        <tr>
          ...
          <th scope="col">Hari Meninggal</th>
      ...
      <tbody>
          @foreach ($kematian as $data)
              <tr>
                  ...
                  <td>
                    <a href="/surat/kematian/{{ $data->id }}" class="badge bg-info" target="_blank"><i class="bi bi-printer"></i></a>
                    <a href="/surat/kematian/{{ $data->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
                    <form action="/surat/kematian/{{ $data->id }}" method="POST" class="d-inline">
                      @method('DELETE')
                      @csrf
