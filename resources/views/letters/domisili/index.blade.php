...
@section('container')
  ...
  <div class="row justify-content-center">
    <div class="col-md-6 mb-1">
      <form action="/surat/domisili" method="GET">
        {{-- @if (request('category')) 
  ...
  <a href="/surat/domisili/create" class="btn btn-primary">Buat Surat Domisili</a>
      ...
      <tbody>
          @foreach ($domisili as $data)
              <tr>
                  ...
                  <td>{{ $data['alamat'] }}</td>
                  <td>
                    <a href="/surat/domisili/{{ $data->id }}" class="badge bg-info" target="_blank"><i class="bi bi-printer"></i></a>
                    <a href="/surat/domisili/{{ $data->id }}/edit" class="badge bg-warning"><i class="bi bi-pencil"></i></a>
                    <form action="/surat/domisili/{{ $data->id }}" method="POST" class="d-inline">
                      @method('DELETE')
                      @csrf
